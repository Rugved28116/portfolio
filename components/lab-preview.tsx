              ...
              <li key={entry.id}>
                <article className="grid min-w-0 gap-6 p-5 sm:p-6 md:grid-cols-[minmax(0,1fr)_12rem] md:gap-8">
                  <div className="min-w-0">
                    ...
                    <h3 {...maintenancePart(`lab-${entry.slug}-title`)} className="mt-3 break-words text-xl font-semibold tracking-[-0.025em] text-foreground sm:text-2xl">
                      {entry.title}
                    </h3>
                    <p {...maintenancePart(`lab-${entry.slug}-description`)} className="mt-3 max-w-2xl text-sm leading-6 text-muted">
                  ...
                  <div className="min-w-0 border-t border-border pt-5 md:border-t-0 md:border-l md:pt-0 md:pl-6">
                    {entry.status ? (
                      <p {...maintenancePart(`lab-${entry.slug}-status`)} className="mb-5 w-fit border border-accent px-2 py-1 font-mono text-[0.6875rem] font-semibold uppercase tracking-[0.14em] text-foreground">
                        Status / {entry.status}
                      </p>
                    ) : null}
                    ...
                    <p {...maintenancePart(`lab-${entry.slug}-categories`)} className="mt-2 break-words font-mono text-xs uppercase leading-5 tracking-[0.08em] text-foreground">
